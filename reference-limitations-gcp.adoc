...
Wenn Sie Hebelwirkung https://cloud.google.com/vpc/docs/private-service-connect["Google Private Service Connect"^] Innerhalb der VPC, in der Sie Cloud Volumes ONTAP bereitstellen, müssen Sie DNS-Einträge implementieren, die den Verkehr an die erforderlichen https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-google.html["API-Endpunkte"^] .
