...
. Diese VM-Typen verwenden ein https://["Ultra SSD"^] Für VNVRAM-Speicher, das eine bessere Schreib-Performance bietet.
+
...
. Eine hohe Schreibgeschwindigkeit wird bei allen Instanztypen unterstützt, wenn ein System mit einem einzelnen Node verwendet wird. Sie können hohe Schreibgeschwindigkeit von BlueXP während der Bereitstellung oder jederzeit danach aktivieren. https://["Erfahren Sie mehr über die Auswahl einer Schreibgeschwindigkeit"^].
. Bei Verwendung von SSDs ist die verbesserte Schreib-Performance aktiviert.
. Informationen zur regionalen Unterstützung für Azure finden Sie unter https://["Cloud Volumes Regionen Weltweit"^].
...
. Cloud Volumes ONTAP unterstützt bei der Verwendung eines HA-Paars eine hohe Schreibgeschwindigkeit mit diesen VM-Typen. Sie können hohe Schreibgeschwindigkeit von BlueXP während der Bereitstellung oder jederzeit danach aktivieren. https://["Erfahren Sie mehr über die Auswahl einer Schreibgeschwindigkeit"^].
