...
| Maximale Systemkapazität (Festplatten + Objekt-Storage) | 2 tib ^1^ | 10 tib | 368 tib | 368 tib pro Lizenz 
...
NOTE: Sie können die folgenden Konfigurationen für die bestehenden Cloud Volumes ONTAP HA-Page-Blob-Implementierungen in Azure nutzen. Seiten-Blobs werden für neue Bereitstellungen nicht unterstützt.
