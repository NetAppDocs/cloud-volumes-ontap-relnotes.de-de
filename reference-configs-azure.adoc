...
. Informationen zu den unterstützten Datenträgertypen für HA-Bereitstellungen mit einer oder mehreren Verfügbarkeitszonen finden Sie unter  https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/reference-default-configs.html#azure-ha-pair["Azure (HA-Paar)"^] .
