...
https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-backup-to-cloud.html["BlueXP Backup und Recovery für Backup und Restore von ONTAP Daten"^].
