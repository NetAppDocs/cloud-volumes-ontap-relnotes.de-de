...
Ab Cloud Volumes ONTAP 9.13.0 stehen _Flash Cache_, hohe Schreibgeschwindigkeit und eine höhere maximale Übertragungseinheit (MTU) von 8,896 Byte für die folgenden HA-Paar-Bereitstellungsinstanzen zur Verfügung: * n2-Standard-16 * n2-Standard-32 * n2-Standard-48 * n2-Standard-64
