...
Bei Einzelknotenbereitstellungen ab Cloud Volumes ONTAP 9.18.1 wird Flash Cache standardmäßig aktiviert, wenn Sie die lokalen SSD (LSSD) Varianten der C3 VMs auswählen. Sie können in Ihrer Cloud Volumes ONTAP Bereitstellung nicht zwischen den C3 LSSD VM Varianten wechseln, selbst wenn die Zielvariante Flash Cache unterstützt.
