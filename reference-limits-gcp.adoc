...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-ha-google-cloud.html["Funktionsweise von Storage in einem Cloud Volumes ONTAP HA-Paar in Google Cloud"^].
